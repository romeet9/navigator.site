...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, imageSrc, link }) => {
  return (
    <div className="w-full max-w-[37rem] mx-auto">
      <div className="relative w-full pb-[69.75%] bg-fill rounded-[0.25rem] overflow-hidden">
        <a 
          href={link}
          className="absolute inset-[0rem] cursor-pointer"
        >
          <div className="absolute inset-[0rem] z-10 shadow-inset-tertiary rounded-[0.25rem] pointer-events-none"></div>
